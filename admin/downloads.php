...
<head>
<meta charset="utf-8"/>
<title>All Subscription Downloads</title>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>All Subscription Downloads
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<!--<a id="sample_editable_1_new" href="web-users.php" class="btn green">
