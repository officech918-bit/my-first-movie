<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
  ...
  <li> <a href="javascript:;"> <i class="icon-docs"></i> <span class="title">Testimonials</span> <span class="arrow "></span> </a>
    <ul class="sub-menu">
      <li> <a href="testimonials.php"> Add/Edit Testimonials</a> </li>
      <li> <a href="all-testimonials.php"> Manage All</a> </li>
    </ul>
  </li>
  ...
  <li data-container="body" data-placement="right" data-html="true" > <a href="profile.php"> <i class="icon-user"></i> <span class="title"> My Profile </span> </a> </li>
</ul>