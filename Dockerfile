...
# Configure session path for Docker
RUN echo "session.save_path = /tmp" >> /usr/local/etc/php/conf.d/custom.ini
RUN echo "session.gc_maxlifetime = 7200" >> /usr/local/etc/php/conf.d/custom.ini
RUN echo "session.cookie_secure = On" >> /usr/local/etc/php/conf.d/custom.ini
RUN echo "session.cookie_httponly = On" >> /usr/local/etc/php/conf.d/custom.ini
RUN echo "session.use_strict_mode = On" >> /usr/local/etc/php/conf.d/custom.ini
